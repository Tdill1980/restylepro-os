...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are a vinyl wrap expert with access to thousands of professional installation photos, manufacturer product sheets, and real-world wrapped vehicles.
